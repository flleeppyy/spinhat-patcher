...
//   try {
//     // git log HEAD
//     const exec = child_process.execSync("git log HEAD --max-count 1", {
//       cwd: spinhatDir,
//     });

//     return parseLog(exec.toString());
//   } catch (e) {
//     return null;
//   }
// }
...
//       "git log HEAD origin/master --max-count 1",
//       {
//         cwd: spinhatDir,
//       }
//     );
...
namespace Downloader {
  ...
  function download2(): Promise<boolean>;
  function update(force: boolean): Promise<number>;
  function uninstall(): Promise<boolean | null>;
  function getLocalCommit(): Promise<Commit | null>;
  function getRemoteCommit(): Promise<Commit | null>;
  function getChanges(): Promise<Change[] | null>;
}